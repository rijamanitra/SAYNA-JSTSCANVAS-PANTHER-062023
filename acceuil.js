...
let imageConteneurGauche = document.querySelector('#conteneurImgGauche');
let imageConteneurMilieu = document.querySelector('#conteneurImgMilieu');
let imageConteneurDroite= document.querySelector('#conteneurImgDroite');
let NomPersonnageGauche = document.querySelector('#ConteneurName1');
let NomPersonnageMilieu = document.querySelector('#ConteneurName2');
let NomPersonnageDroite = document.querySelector('#ConteneurName3');
let DescriptionPersonnageGauche = document.querySelector('#persoDescription1');
let DescriptionPersonnageMilieu = document.querySelector('#persoDescription2');
let DescriptionPersonnageDroite = document.querySelector('#persoDescription3');
let letsSlide = document.querySelector('#btnSlide');
